  ...
  <!--            Modal tạo-->
    <a-modal v-model:visible="visibleModal"
        ...
        <a-form ref="formDataRef"
            ...
            <a-row :gutter="[10, 10]">
                <a-col :md="12" :xs="24">
                    <a-form-item :rules="[{ required: true, message: 'Tên chuyên mục là bắt buộc.' }]"
                ...
                <a-col :md="12" :xs="24">
                    <a-form-item :rules="[{ required: true, message: 'Thứ tự hiển thị là bắt buộc' }]"
                ...
                <a-col :md="12" :xs="24">
                    <a-form-item :rules="[{required: formData.isSubCategory, message: 'Chuyên mục cha không được để trống' }]"
                ...
                <a-col :md="12" :xs="24">
                    <a-form-item :rules="[{required: true, message: 'Bạn phải chọn ít nhất một nơi đăng tin' }]"
                                 label="Nơi đăng tin"
                                 name="placeAppear">
